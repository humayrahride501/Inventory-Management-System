...
public class addtocart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MainFiles/three.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //   ProductInformation.categoryChooser = "electronics";
        try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3307/inventory?zeroDateTimeBehavior=CONVERT_TO_NULL","root","");
...
{DefaultTableModel model=(DefaultTableModel)table2.getModel();
    ...
    Class.forName("com.mysql.cj.jdbc.Driver");
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/inventory?zeroDateTimeBehavior=CONVERT_TO_NULL","root","");
     ...
     public void workWithDatabase()
    {
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");
       c=DriverManager.getConnection("jdbc:mysql://localhost:3307/inventory?zeroDateTimeBehavior=CONVERT_TO_NULL","root","");
       s=c.createStatement();
   ...
   // jLabel6.setText(s1);
         ...
         /*     while(rs1.next())
       {
             ...
             rs1.close();
               ...
               JOptionPane.showMessageDialog(this,"Please select a row form the table");
           }
